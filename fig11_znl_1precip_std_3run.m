...
pth1 = ['/scratch1/BMC/gsd-hpcs/Shan.Sun/wfw_wgne_ctrl_exp/COMROOT/noa00/gfs.'];
...
for mm=1:2
 if (mm==1) mon=5; amon='May';i1=0.04;j1=.5;end
 if (mm==2) mon=9; amon='Sep';i1=0.52;end
...
ave = ['ProgAer (ave=',num2str(y3a,'%04.2f'),')'];
text(m0,n1,ave,'FontSize',sz9,'color','r')
ave = ['ClimAer (ave=',num2str(y2a,'%04.2f'),')'];
text(m0,n2,ave,'FontSize',sz9,'color','b')
ave = ['NoAer (ave=',num2str(y1a,'%04.2f'),')'];
text(m0,n3,ave,'FontSize',sz9,'color','g')
...
axes('position',[0.35 .87 0.3 0.01])
